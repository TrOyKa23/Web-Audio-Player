document.addEventListener('DOMContentLoaded', function () {
    ...
    // Server upload 
        // ======================
    // 🚀 Загрузка треков с сервера при старте
    // ======================
    fetch('/tracks')
        .then(res => res.json())
        .then(serverTracks => {
        ...
        .catch(err => console.error('Ошибка загрузки треков с сервера:', err));
    ...
    files.forEach(file => formData.append('tracks', file)); // ключ должен быть "tracks"
